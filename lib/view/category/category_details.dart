...
class _CategoryDetailsListState extends State<CategoryDetailsList>
  ...
  List images=[banner,services,window,hotel,ro,];
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text("Khan Chicken and meat Shop", style: GoogleFonts.alice(
                            color: textBlack,
                            fontWeight: FontWeight.bold,
                            fontSize: 16),),
                        Text("Owner Name : Rahim", style: GoogleFonts.alice(
                            color: btnColor,
                            fontWeight: FontWeight.bold,
                            fontSize: 14),)
                      ],
                  ...
                  Text("My business Address:", style: GoogleFonts.alice(fontSize: 16,color: btnColor,fontWeight: FontWeight.w400),),
                  const SizedBox(height: 5,),
                  // Row(
                  //   children: const [
                  ...
                  //   ],
                  // ),
                  Text("first floor room no -101,Noida City, Noida,110015", style: GoogleFonts.alice(fontSize: 16),),
                  const SizedBox(height: 5,),
                  Text("My Services:", style: GoogleFonts.alice(fontSize: 16,color: btnColor,fontWeight: FontWeight.w400),),
                  Text("Chicken leg,full leg,Mutton,Boneless leg Chicken,Chicken Lollipop etc", style: GoogleFonts.alice(fontSize: 16),),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.end,
                    children: [
                      Image.asset(whatsapp,height: 40,),
                      const SizedBox(width: 10,),
                      const CircleAvatar(radius: 15,
                          backgroundColor:primary,
                          child: Icon(Icons.call,color: textWhite,size: 20,)),
                      const SizedBox(width: 10,),
                      const CircleAvatar(radius: 15,
                          backgroundColor:primary,
                          child: Icon(Icons.call,color: textWhite,size: 20,))
